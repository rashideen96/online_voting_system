        ...
        <div class="modal-content">
				...
				<h4 class="modal-title" id="myModalLabel">         
					<div class="panel panel-primary">
						<div class="panel-heading">
							<center>Add President & Vice President</center>
						</div>    
					</div>
				</h4>
			</div>
			...
			<?php 
				...
				if (isset ($_POST ['save'])){
					...
					$conn->query("INSERT INTO candidate(position,party,firstname,year_level,gender,img)values('$position','$party','$fullname','$year_level','$gender','$location')")or die(mysql_error());
				}						
			?>					
        </div>
