        ...
        <div class="modal-content">
			...
			<?php 
				...
				if (isset ($_POST ['save'])){
					...
					$conn->query("INSERT INTO candidate(position,party,firstname,lastname,year_level,gender,img)values('$position','$party','$firstname','$lastname','$year_level','$gender','$location')")or die(mysql_error());
				}						
			?>					
        </div>
