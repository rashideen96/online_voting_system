    ...
    <div id="row">
			...
			if(ISSET($_POST['submit']))
				{
					if (!isset($_POST['party'])) {
						...
						$_SESSION['p_id'] = $_POST['party'];
					}

					if (!isset($_POST['faculty'])) {
						$_SESSION['f_id'] = "";
					} else {
						$_SESSION['f_id'] = $_POST['faculty'];
					}
		...
		?>
		  ...
		  <div class = "alert alert-info">
			<div class="panel-heading"><center>Party</center></div>
			<br />
			<?php
				if (!$_SESSION['p_id']) {
					# code...
				} else {
					$fetch = $conn->query("SELECT * FROM party WHERE id='$_SESSION[p_id]'")->fetch_array();

					echo $fetch['party_id']." ".$fetch['president']." ".$fetch['vice_president']." "."<img src = 'admin/".$fetch['img']."' style = 'height:80px; width:80px; border-radius:500px;' />"; 
				}
			...
			<div class="panel-heading"><center>Faculty</center></div>
			<br />
			<?php
				if(!$_SESSION['f_id'])
					{
